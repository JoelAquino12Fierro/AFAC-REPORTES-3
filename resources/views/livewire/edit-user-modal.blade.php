    ...
    <x-dialog-modal wire:model="open">
        ...
        <x-slot name="footer">
            <div class="flex justify-between w-full">
                ...
                <div>
                    <button wire:click="$set('confirmEdit', true)" class="bg-green-500 font-semibold text-white px-4 py-2 rounded-lg">Guardar Usuario</button>
                </div>
            </div>
        </x-slot>
    </x-dialog-modal>

    <x-dialog-modal wire:model="confirmEdit">
        <x-slot name="title">
            titulo
        </x-slot>
        <x-slot name="content">
