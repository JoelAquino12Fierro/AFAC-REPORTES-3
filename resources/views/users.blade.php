                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg border border-gray-200">
                            ...
                            <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-gray-50 p-4 rounded-t-lg border-b border-gray-300"> 
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="table-search-users" class="mt-4 left-2 block p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-100 focus:ring-blue-500 focus:border-blue-500 shadow-md" placeholder="Buscar Usuario">
                                </div>
