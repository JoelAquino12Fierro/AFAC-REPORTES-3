        ...
        <div class="px-14 py-14">
            ...
            <div class="flex flex-row">
                <div class="basis-1/7 mb-4 mr-2">
                    ...
                    <button type="button"
                        class=" \F4FA w-1/8 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-sky-500 text-white hover:bg-sky-700 ">Nuevo
                        reporte</button>
                </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-900 dark:text-gray-400 px-5 py-5">
                ...
                <tbody>
                    <ul>
                        <tr
                            class=" bg-white dark:bg-white dark:text-black-400 text-sm ">
