                    ...
                    <tbody>
                        ...
                        Eliminar --}}
                            ...
                            <td>
                                <form action="{{ route('reports.edit', $reporte->id) }}" method="GET">
                                    @csrf
                                    <button type="submit" class="bg-teal-500 text-white font-bold py-2 px-4 rounded-lg flex items-center space-x-2 transition duration-300 ease-in-out hover:bg-teal-600 active:bg-teal-700">
                                        Ver detalles
                                    </button>
                                </form>
                            </td>
                            <td>
                                <form action="{{ route('reports.destroy', $reporte->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="bg-red-500 text-white font-bold py-2 px-4 rounded-lg flex items-center space-x-2 transition duration-300 ease-in-out hover:bg-red-600 active:bg-red-700">
                            ...
                            <td>
                                ...
                                <form action="{{ route('pdf', $reporte->id) }}" method="GET">
                                    ...
                                    <button type="submit" class="bg-azul-afac hover:bg-azul-afac text-white font-bold py-2 px-4 rounded-lg flex items-center space-x-2 transition duration-300 ease-in-out transform hover:scale-105">
